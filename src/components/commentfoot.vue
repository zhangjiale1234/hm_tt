<template>
  <div class="comment">
    <div class="comment_box" v-if="!isFocus">
      <div class="comment_left">
        <input type="text" placeholder="写跟帖" @focus="haedleblur" />
      </div>
    ...
    <div class="inputcomment" v-if="isFocus">
      <textarea
        ref="commtext"
        rows="5"
        autofocus
...
<script>
import { sentComment } from '@/api/myapi.js'
export default {
  props: ['posts'],
  data () {
    return {
  ...
  methods: {
    ...
    async sendcomment () {
      ...
      // 获取文本域的内容
      const commentText = this.$refs.commtext.value
      // 获取文章id
